...
<%@ page contentType="text/html; charset=iso-8859-1" language="java" 
	import="javax.servlet.*, javax.servlet.http.*, com.expedia.business.manager.TicTacToeManager,	 
...
<body>
<%
TicTacToeManager gm = (TicTacToeManager) request.getSession().getAttribute("gameManager");
char[][] tiles;
